...
<div class="glass-card w-full max-w-lg rounded-3xl p-8 sm:p-12 relative overflow-hidden">
    ...
    <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-2 tracking-tight">Buat Akun Baru</h1>
    ...
    <div class="mt-8 text-center border-t border-gray-100 pt-6">
        <p class="text-gray-600 text-sm">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="text-emerald-600 font-bold hover:text-emerald-800 transition-colors ml-1 hover:underline decoration-2 underline-offset-2">Login disini</a>
        </p>
    </div>
</div>
@endsection