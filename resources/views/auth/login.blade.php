...
<div class="glass-card w-full max-w-lg rounded-3xl p-8 sm:p-12 relative overflow-hidden">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-500 text-sm">Silakan login untuk menikmati hidangan kami</p>
    </div>

    @if (session('success'))
    <div class="mb-6 p-4 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm flex items-center gap-3 shadow-sm">
